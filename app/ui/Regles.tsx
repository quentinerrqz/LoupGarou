    ...
    <div className={`absolute right-0 top-0 z-30 `}>
        ...
        {open && (
            ...
            <ul>
                ...
                <li>Les joueurs peuvent discuter et voter pour éliminer un autre joueur au cours d'un vote.</li>
                <li>Le jeu se termine lorsque tous les loups-garous sont éliminés ou que les villageois sont en minorité.</li>
                <li>Les rôles spéciaux ont des capacités uniques.</li>
                <li>Le jeu se joue en plusieurs tours, alternant entre la nuit et le jour.</li>
                <li>Les joueurs doivent utiliser leur stratégie et leur persuasion pour gagner.</li>
